...
% STEP#3: Plot Power Spectrum (PSD) using Yule-Walker Method of CNN Learned Kernels.
...
w1=squeeze(w1)
w11= w1(:,u)
M = bsxfun(@rdivide,w11,std(w11)); % Normalize
[pxx391,F1] = pyulear(M,10,1:25,Fs)
[dummy, st] = max(pxx391);
index1=find(st>0 & st<=5);
